...
func withJtagUsbDevice(f func(*gousb.Device)) {
...
func withJtagUsbEndpoints(f func(*gousb.OutEndpoint, *gousb.InEndpoint)) {
...
func jtagBasicTransaction(w *gousb.OutEndpoint, r *gousb.InEndpoint, irVal, tdLen, tdi int) (tdo int) {
