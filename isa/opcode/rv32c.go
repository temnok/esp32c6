...
func (gen *gen) C_AND(rd, rs2 int) { gen.CS(0x8C61, rd, rs2, 0) }
func (gen *gen) C_MV(rd, rs2 int)  { gen.CR(0x8002, rd, rs2) }
func (gen *gen) C_OR(rd, rs2 int)  { gen.CS(0x8C41, rd, rs2, 0) }
func (gen *gen) C_SUB(rd, rs2 int) { gen.CS(0x8C01, rd, rs2, 0) }
func (gen *gen) C_XOR(rd, rs2 int) { gen.CS(0x8C21, rd, rs2, 0) }
...
func (gen *gen) C_BEQZ(rd, imm int) { gen.CBB(0xC001, rd, imm) }
func (gen *gen) C_BNEZ(rd, imm int) { gen.CBB(0xE001, rd, imm) }
